...
function_maps("excess_rate_group")
```
...
```{r, echo=FALSE,message=FALSE,fig.height = 12,  fig.width = 10}
function_maps_sex("excess_rate_group")
```

```{r, echo=FALSE,message=FALSE,fig.height = 12,  fig.width = 10}
function_maps_sex("excess_per_year_quant2")
```
...
### Maps
```{r, echo=FALSE,message=FALSE,fig.height = 12,  fig.width = 10}
function_maps_age2("excess_rate_group")
```

```{r, echo=FALSE,message=FALSE,fig.height = 12,  fig.width = 10}
function_maps_age2("excess_per_year_quant2")
```
