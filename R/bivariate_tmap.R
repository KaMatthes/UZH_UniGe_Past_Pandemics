...
# bvColors <- c("#c85a5a","#e4acac" , "#e8e8e8",
#               "#985356","#ad9ea5" ,"#b0d5df" ,
#               "#574249", "#627f8c", "#64acbe" )
...
# 
# bvColors <- c("#e8e8e8","#e4acac","#c85a5a",
#           "#b0d5df","#985356","#ad9ea5",
#           "#574249","#64acbe","#627f8c")



# bvColors <- c("#c85a5a","#e8e8e8","#e4acac",
#               "#b0d5df","#ad9ea5","#985356",
#               "#64acbe","#627f8c","#c85a5a")
# "#e8e8e8" <- weiss
# 
...
get_bivariate_choropleth <- function (
  ...
  bivmap <- tm_shape(bivmap_sdf) + 
    ...
    # tm_shape(bivmap_sdf) + 
     # tm_symbols(size = "Prop_Norm", scale = 2, alpha=1, col="black")
