...
pop_2010_2020 <- readxl::read_excel("data_raw/Data2020/Population_total2010_2020.xlsx") %>%
  ...
  mutate(MapName=recode(MapName, "d'Aigle"  = "Aigle",
                        ...
                        "Inner-Rhoden" = "Appenzell Innerrhoden",
  ...
  mutate(Year=as.character(Year),
         Year = as.numeric(Year))
# write.xlsx(pop_2010_2020,file=paste0("data/pop_2010_2020.xlsx"),rowNames=FALSE, overwrite = TRUE)

pop_total <- rbind(pop_extrapolate, pop_2010_2020)
save(pop_total,file="data/pop_total.RData")
write.xlsx(pop_total,file="data/pop_total.xlsx",rowNames=FALSE, overwrite = TRUE)
