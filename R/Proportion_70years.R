...
prop_70_year <- rbind(pop_extrapolate_age, pop_2014_2020_age) %>%
...
write.xlsx(prop_70_year  ,file=paste0("data/prop_70_year.xlsx"),row.names=FALSE, overwrite = TRUE)
save(prop_70_year ,file=paste0("data/prop_70_year.RData"))
