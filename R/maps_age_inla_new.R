function_maps_sex <- function(var){
  ...
  load(paste0("data/expected_death_inla0_19_1890.RData"))
  death_1890_0_19 <- expected_deaths
  
  load(paste0("data/expected_death_inla0_19_1918.RData"))
  death_1918_0_19 <- expected_deaths
  
  load(paste0("data/expected_death_inla0_19_2020.RData"))
  death_2020_0_19<- expected_deaths
  
  load(paste0("data/expected_death_inla20_39_1890.RData"))
  death_1890_20_39 <- expected_deaths
  
  load(paste0("data/expected_death_inla20_39_1918.RData"))
  death_1918_20_39 <- expected_deaths
  
  load(paste0("data/expected_death_inla20_39_2020.RData"))
  death_2020_20_39 <- expected_deaths
  
  load(paste0("data/expected_death_inla40_69_1890.RData"))
  death_1890_40_69 <- expected_deaths
  
  load(paste0("data/expected_death_inla40_69_1918.RData"))
  death_1918_40_69 <- expected_deaths
  
  load(paste0("data/expected_death_inla40_69_2020.RData"))
  death_2020_40_69 <- expected_deaths
  ...
  data_excess <- rbind(death_1890_0_19,death_1918_0_19,death_2020_0_19,
                       death_1890_20_39,death_1918_20_39,death_2020_20_39,
                       death_1890_40_69,death_1918_40_69, death_2020_40_69,
  ...
  if(Year_Pan==2020) {
    bezirk_geo <- bezirk_geo %>%
      mutate(excess_perc_groups =  cut(excess_percentage, 
                                       breaks = c(-100, 0, 5, 10, 15,20, 30, 40, 50,8.540e+109 ), 
