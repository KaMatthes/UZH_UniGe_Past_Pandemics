function_inla_age <- function(Year_Pan,Year_max, Year_min, Age, Name) {
  load(paste0("data/data_mortality_rate_age_1918.RData"))
...
dat.excess <- data_mortality_rate_age_1918 %>%
...
function_inla_age(Year_Pan=1918, Year_max=1919, Year_min=1914, Age="20_29", Name="20_29")
function_inla_age(Year_Pan=1918, Year_max=1919, Year_min=1914, Age="30_39", Name="30_39")
