...
```{r, echo=FALSE,message=FALSE}
function_maps_1890_1818()
```

### Relation between 1918 and proportion >=30 years
...
Tuberculosis mortalityiy is significantly associated with excess mortality in 1890, but not in 1918. 

<!-- This suggests that the 1918 pandemic had a greater impact on mortality than tuberculosis. Whereas in 1890 tuberculosis played a greater role.  -->
