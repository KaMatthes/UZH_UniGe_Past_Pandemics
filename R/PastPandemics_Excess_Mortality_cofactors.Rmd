...
<!-- ```{r, echo=FALSE,message=FALSE,fig.height = 8,  fig.width = 12} -->
<!-- function_hotspot_sex(Year_Pan=1890, Sex="m") -->
<!-- function_hotspot_sex(Year_Pan=1890, Sex="f") -->
<!-- function_hotspot_sex(Year_Pan=1918, Sex="m") -->
<!-- function_hotspot_sex(Year_Pan=1918, Sex="f") -->
<!-- function_hotspot_sex(Year_Pan=2020, Sex="m") -->
<!-- function_hotspot_sex(Year_Pan=2020, Sex="f") -->
<!-- ``` -->
